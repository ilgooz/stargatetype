...
import (
	...
	appparams "github.com/j/j8/app/params"
	"github.com/j/j8/x/j8"
	j8keeper "github.com/j/j8/x/j8/keeper"
	j8types "github.com/j/j8/x/j8/types"
)

var (
	// DefaultNodeHome default home directories for the application daemon
	DefaultNodeHome = func(appName string) string {
		return os.ExpandEnv("$HOME/j8d")
	}
...
func New(
	...
	keys := sdk.NewKVStoreKeys(
		authtypes.StoreKey, banktypes.StoreKey, paramstypes.StoreKey, stakingtypes.StoreKey, //j8types.StoreKey, 
	)
	...
	app.j8Keeper = *j8keeper.NewKeeper(
        appCodec, keys[j8types.StoreKey], keys[j8types.MemStoreKey],
	)
	...
	app.mm = module.NewManager(
		...
		j8.NewAppModule(appCodec, app.j8Keeper),
	)
